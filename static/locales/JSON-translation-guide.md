...
Here we explain how to properly format translation files (`.json`) for use in Over the Board. The format is designed to be clean, consistent, and easy to use for translators both technical and non-technical—via platforms such as Crowdin.
